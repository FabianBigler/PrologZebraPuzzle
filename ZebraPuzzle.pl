...
houses(Hs) :-	
	...
	neighbour(house(_,_,_,_,green), house(_,_,_,_,white), Hs),      % 6) The green house is immediately to the right of the ivory house.
	member(house(_,snake,winston,_,_), Hs),                       	% 7) The Old Gold smoker owns snails.
	...
	member(house(japonese,_,kent,_,_), Hs),                       	% 14) The Japanese smokes Parliaments.
